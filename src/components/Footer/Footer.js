...
const Footer = () => {
    return <div className='footer'>
        <div className='footer-content'>
            ...
            <div className="footer-col">
                <div className="logo">
                    ...
                    <div className='name'>
                        <b>Cyclone</b><br></br> Boutique

                    </div>
                </div>
                <br />
                <div className="footer-desc">
                    <strong>Cyclone Boutique</strong>
            ...
            <div className="footer-col">
                <div className="footer-links">
                    ...
                    <div className="touch">
                        <strong>Asia Headquater</strong>
                        <div className="detail">

                            Kupondole-1, Lalitpur, Nepal
                        </div>
                        <div className="detail">
                            +977 1234567890
                        </div>
                    ...
                    <div className="touch">
                        <strong>Europe Headquater</strong>
                        <div className="detail">
        ...
        <div className='copyright'>
            &copy; 2021 Cyclone Boutique. All Rights Reserved.
        </div>
    </div>
}
